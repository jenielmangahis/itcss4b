...
class GlobalHelper
{
      public static function load_country_code() 
      {
            $countries = array
            (
                  'AF' => 'Afghanistan',
      ...
      public static function loadNumbers($max_number = 0) {

            for ($num_inc = 1; $num_inc <= $max_number; $num_inc++) {
                $numbers[] = $num_inc;
            } 
      ...
      public static function is_serialized_string($string) {
