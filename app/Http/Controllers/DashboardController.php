...
class DashboardController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        */        
        ...
        $contactBankAccount = ContactBankAccount::where('contact_id','=', $contact_id)->first();
        ...
        */
        ...
        $contactCreditCard = ContactCreditCard::where('contact_id','=', $contact_id)->first();
        ...
        */
         ...
         * Contact User - start
        */
            $contactUser = ContactUser::where('contact_id','=', $contact_id)->first();
