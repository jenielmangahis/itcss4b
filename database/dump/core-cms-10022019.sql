...
-- Dumping data for table corecmsdb.contact_advances: ~3 rows (approximately)
DELETE FROM `contact_advances`;
/*!40000 ALTER TABLE `contact_advances` DISABLE KEYS */;
INSERT INTO `contact_advances` (`id`, `contact_id`, `company_id`, `lender_id`, `loan_id`, `contract_date`, `contract_number`, `advance_date`, `amount`, `payback`, `balance`, `factor_rate`, `remit`, `period`, `period_type`, `payment`, `advance_type`, `payment_method`, `status`, `created_at`, `updated_at`, `deleted_at`) VALUES
	(1, 27, 0, 1, '230919/7242', NULL, '230919/3278', NULL, 3450.00, 690.00, 0.00, 20.00, 32.00, '5', 'days', 138.00, 'add-on', 'ach', 'Started', '2019-09-23 17:17:28', '2019-09-26 07:54:41', NULL),
	(2, 27, 0, 2, '240919/8415', NULL, '240919/6015', NULL, 8000.00, 2800.00, 0.00, 35.00, 25.00, '10', 'month', 280.00, 'new', 'ach', 'Started', '2019-09-24 16:15:02', '2019-09-26 07:54:13', NULL),
	(3, 28, 0, 1, '260919/6135', NULL, '260919/9772', NULL, 85000.00, 15300.00, 0.00, 18.00, 15.00, '12', 'month', 1275.00, 'renewal', 'cc', 'Started', '2019-09-26 07:55:20', '2019-09-26 07:55:20', NULL);
...
-- Dumping data for table corecmsdb.contact_docs: ~0 rows (approximately)
...
INSERT INTO `users` (`id`, `group_id`, `nickname`, `firstname`, `lastname`, `mobile_number`, `work_number`, `home_number`, `username`, `email`, `email_verified_at`, `password`, `status`, `profile_img`, `is_active`, `remember_token`, `created_at`, `updated_at`, `deleted_at`, `last_login`, `reset_code`) VALUES
	(1, 1, 'B1', 'Bryann', 'Revina', '09279983995', NULL, NULL, 'bryann03', 'bryann.revina@gmail.com', NULL, '$2y$10$t780SAl1b2k0yXzhh5eCtuwOjgzBEukfDScQrs6CW/FUzJHhAF2qK', NULL, '0723844514a8e149966354f21b337c34.jpg', 0, NULL, '2019-05-11 06:03:15', '2019-06-17 05:02:59', NULL, NULL, NULL),
