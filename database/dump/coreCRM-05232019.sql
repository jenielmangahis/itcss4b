...
-- Dumping data for table corecmsdb.companies: ~0 rows (approximately)
...
INSERT INTO `company_users` (`id`, `company_id`, `user_id`, `created_at`, `updated_at`, `deleted_at`) VALUES
	...
	(2, 3, 10, '2019-05-23 15:44:49', '2019-05-23 15:44:49', NULL);
...
-- Dumping data for table corecmsdb.groups: ~0 rows (approximately)
DELETE FROM `groups`;
/*!40000 ALTER TABLE `groups` DISABLE KEYS */;
INSERT INTO `groups` (`id`, `name`, `created_at`, `updated_at`, `deleted_at`) VALUES
	(1, 'this is only a test', '2019-05-17 13:31:13', '2019-05-17 13:31:13', NULL);
...
INSERT INTO `users` (`id`, `group_id`, `nickname`, `firstname`, `lastname`, `mobile_number`, `work_number`, `home_number`, `username`, `email`, `email_verified_at`, `password`, `status`, `is_active`, `remember_token`, `created_at`, `updated_at`, `deleted_at`) VALUES
	...
	(10, 0, 'jukejuke', 'Juke', 'Pangan', '45454545', '45454545', '44545455', 'juke101', 'juke.pangan@test.com', NULL, '$2y$10$aJaKTcfZXvFSeY5FyiDsau6VC2/lm8Z7I2kySSHabQnJxoEl/kYhS', NULL, 0, NULL, '2019-05-23 15:44:49', '2019-05-23 15:44:49', NULL);
