  ...
  <!-- Main content -->
    <section class="content container-fluid">
        ...
        <div class="box box-primary">
          ...
          {{ Form::open(array('url' => 'companies/store', 'class' => '')) }}
            <div class="box-body">
              ...
              <div class="form-group">
                ...
                <?php echo Form::text('facebook', old('facebook') ,['class' => 'form-control']); ?>
              </div>   
              <div class="form-group">
                <label>Twitter</label>
                <?php echo Form::text('twitter', old('twitter') ,['class' => 'form-control']); ?>
              </div>  
              <div class="form-group">
