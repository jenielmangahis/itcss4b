              ...
              <section class="col-lg-9 connectedSortable ui-sortable">
                <div class="nav-tabs-custom contact-dashboard contact-dashboard-tabs">
                  <ul class="nav nav-tabs">
                    ...
                    <li class="dropdown">
                      ...
                      <ul class="dropdown-menu">
                        ...
                        <li role="presentation"><a role="menuitem" tabindex="-1" href="#tab_lenders" data-toggle="tab">Lenders</a></li>
                      </ul>
                    </li>                
                  </ul>
                  ...
                  <div class="tab-content">
                    ...
                    <div class="tab-pane" id="tab_lenders">
                      @include('contact.dashboard.tab-sections.tab_lenders')
                    </div>
