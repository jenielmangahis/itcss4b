...
<ul class="timeline timeline-inverse">
      ...
      <li>
        ...
        <div class="timeline-item"> 
          <h3 class="timeline-header">
            <a class="btn btn-primary btn-sm" href="javascript:void(0);">Module</a> | 
            {{ date("F j, Y, g:i a", strtotime(date('Y-m-d g:i a'))) }}
            | <a class="" href="javascript:void(0);">Title</a>
            | Bryann Revina
            <a style="float: right;" href="javascript:void(0);" class="btn btn-danger btn-xs" data-toggle="modal" data-target="#modalDelete-<?= 1; ?>">
      ...
      <div id="modalDelete-<?= 1; ?>" class="modal fade bs-example-modal-lg" tabindex="-1" role="dialog" aria-hidden="true" style="text-align: left">
