              ...
              <div class="box">
                <div class="box-header with-border">
                    ...
                    <div class="pull-right">
                        <a href="{{route('event_type/create')}}" class="btn btn-primary">
                ...
                <div class="box-body">
                  ...
                  <div class="row">
                    {{ Form::open(array('url' => 'event_type', 'class' => '', 'method' => 'get')) }}
                        ...
                        <div class="row">
                          ...
                          <div class="col-md-6">
                            <div class="form-group">
                              ...
                              <a class="btn btn-success" href="{{route('event_type')}}">Refresh</a>
                            </div>
                            <!-- /.form-group -->
                          </div>
                        </div>                
                    ...
                    @foreach($event_types as $et)
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="{{route('event_type/edit',[Hashids::encode($et->id)])}}" class="btn btn-xs btn-primary">
                            ...
                            <div class="modal-dialog modal-md">
                              <div class="modal-content">
                                ...
                                <div class="modal-body">
                                  Are you sure you want to delete selected event type?
                                </div>
                                <div class="modal-footer">
                                  {{ Form::open(array('url' => 'event_type/destroy')) }}
