              ...
              <div class="box">
                <div class="box-header with-border">
                    ...
                    <div class="pull-right">
                        <a href="{{route('workflow_category/create')}}" class="btn btn-primary">
                ...
                <div class="box-body">
                  ...
                  <div class="row">
                    {{ Form::open(array('url' => 'workflow_category', 'class' => '', 'method' => 'get')) }}
                        ...
                        <div class="row">
                          ...
                          <div class="col-md-6">
                            <div class="form-group">
                              ...
                              <a class="btn btn-success" href="{{route('workflow_category')}}">Refresh</a>
                            </div>
                            <!-- /.form-group -->
                          </div>
                        </div>                
                  ...
                  <table class="table table-bordered table-hover">
                    ...
                    @foreach($workflow_category as $wc)
                        <tr>
                            <td>{{ $wc->id }}</td>
                            <td>{{ $wc->name }}</td>
                            <td>
                                ...
                                <a href="{{route('workflow_category/edit',[Hashids::encode($wc->id)])}}" class="btn btn-xs btn-primary">
                            ...
                            <div class="modal-dialog modal-md">
                              <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                  {{ Form::open(array('url' => 'workflow_category/destroy')) }}
